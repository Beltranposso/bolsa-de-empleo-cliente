...
<p>Home</p>
        ...
        <Link to='/Empleos' className='flex flex-col text-gray-500 items-center hover:text-black'>
...
<p>Empleos</p>
        ...
        <Link  className='flex flex-col items-center text-gray-500 hover:text-black'>
